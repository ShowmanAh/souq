                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item  "><a href="{{route('admin.languages.create')}}">اضافه لغه جديده</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                                           ...
                                           @foreach ($languages as $index => $lang)
                                              <tr>
                                                  ...
                                                  <td>
                                                      ...
                                                      <a href="{{ route('admin.languages.destroy', $lang->id)}}"  class="btn btn-outline-danger btn-sm box-shadow-3 mr-1 mb-1">Delete</a>
                                                  </td>
                                                </tr>
                                                  @endforeach
