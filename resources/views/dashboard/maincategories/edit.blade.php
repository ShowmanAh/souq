                                    ...
                                    <form class="form" action="{{ route('admin.maincategories.update', $main_category->id)}}" method="POST"
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="text-center">
                                            <img src="{{ $main_category->image}}" alt="" class="rounded-circle height-150">
                                        </div>
                                       ...
                                       <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="projectinput1"> اسم القسم - {{__('messages.'.$main_category -> translation_lang)}} </label>
                                                <input type="text" value="{{$main_category->name}}" id="name"
                                                       class="form-control"
                                                       placeholder="  "
                                        ...
                                        <div class="col-md-6  hidden">
                                            <div class="form-group">
                                                <label for="projectinput1"> أختصار اللغة {{__('messages.'.$main_category -> translation_lang)}} </label>
                                                <input type="text" id="abbre"
                                                       class="form-control"
                                                       placeholder="  "
                                                       value="{{$main_category -> translation_lang}}"
                                                       name="category[0][abbre]">

                                                @error("category.0.abbre")
                                                <span class="text-danger">{{$message}}  </span>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-1">
                                                ...
                                                <label for="switcheryColor4"
                                                       class="card-title ml-1">الحالة  {{__('messages.'.$main_category -> translation_lang)}} </label>
                                    ...
                                    <ul class="nav nav-tabs">
                                        @isset($main_category -> categories)
                                            @foreach($main_category -> categories   as $index =>  $translation)
                                                <li class="nav-item">
                                                    <a class="nav-link " id="homeLable-tab"  data-toggle="tab"
