                                    ...
                                    <form class="form" action="{{ route('admin.maincategories.store')}}" method="POST"
                                       ...
                                       @csrf
                                        ...
                                        <div class="form-body">
                                            ...
                                            @if (getActiveLanguage()->count() > 0)
                                       @foreach (getActiveLanguage() as $index=>$lang)


                                       <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="projectinput1"> اسم القسم - {{__('messages.'.$lang -> abbre)}} </label>
                                        ...
                                        <div class="col-md-6  hidden">
                                            <div class="form-group">
                                                <label for="projectinput1"> أختصار اللغة {{__('messages.'.$lang -> abbre)}} </label>
                                                <input type="text" id="abbre"
                                                       class="form-control"
                                                       placeholder="  "
                                                       value="{{$lang->abbre}}"
                                                       name="category[{{$index}}][abbre]">

                                                @error("category.$index.abbre")
                                                <span class="text-danger"> {{$message}}  </span>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-1">
                                                ...
                                                <label for="switcheryColor4"
                                                       class="card-title ml-1">الحالة  {{__('messages.'.$lang -> abbre)}} </label>
