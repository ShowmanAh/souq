...
<style type="text/css">
  ...
  @include('layouts.site.includes.header_mobile')

  @include('layouts.site.includes.header_top')


  @include('layouts.site.includes.header_center')
  @include('layouts.site.includes.header_bottom')
